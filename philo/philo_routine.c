...
/*   Updated: 2025/03/22 14:16:44 by aouanni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	handle_single_philo(t_philo *philos)
{
	...
	{
		ft_usleep(philos->shared_data->t_die, should_stop(philos));
...
void	philo_eat(t_philo *philos)
{
	...
	ft_usleep(philos->shared_data->t_eat, should_stop(philos));
...
void	think_nd_sleep(t_philo *philos)
{
	...
	ft_usleep(philos->shared_data->t_sleep, should_stop(philos));
